...
A **value** is a single piece of data. Four kinds you'll use constantly:
...
A small, famous exercise that exercises loops, conditionals, and the modulo
operator (`%`) together — a solid capstone before moving on:
